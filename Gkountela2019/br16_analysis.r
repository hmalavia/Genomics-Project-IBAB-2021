...
write.csv(upreg,'scran_results/Br16_upregulated_genes_ALL_edgeR.csv',quote = F)

Downregs <- Downregs[order(Downregs$logFC),]

write.csv(Downregs,'scran_results/Br16_downregulated_genes_ALL_edgeR.csv',quote = F)
